...
const OPTION_META = [
  ...
  {
    label: "B",
    grad: "rgba(59,130,246,0.15)",
    border: "rgba(59,130,246,0.25)",
    color: "#93c5fd",
  },
  {
    label: "C",
    grad: "rgba(245,158,11,0.15)",
    border: "rgba(245,158,11,0.25)",
    color: "#fcd34d",
  },
  {
    label: "D",
    grad: "rgba(168,85,247,0.15)",
...
export function QuestionCardPlaceholder({
  index = 1,
  questionData = { text: "", options: ["", "", "", ""], correct: 0 },
  onChange,
  onDelete,
  onDuplicate,
}: QuestionCardProps) {
  ...
  const handleMediaUrl = () => {
    if (mediaInputVal.trim()) {
      setMediaUrl(mediaInputVal.trim());
      setShowMediaInput(false);
    }
  };
  ...
  return (
    <div
      ...
      style={{
        ...
        background:
          "linear-gradient(145deg, rgba(17,24,39,0.95), rgba(15,23,42,0.9))",
        backdropFilter: "blur(20px)",
        boxShadow: isActive
          ? "0 0 0 3px rgba(236,72,153,0.12), 0 24px 60px rgba(0,0,0,0.4)"
    ...
    >
      ...
      >
            ...
            {(
              ...
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  background:
                    qType === key ? "rgba(236,72,153,0.25)" : "transparent",
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "0.15rem" }}>
          ...
          <button
            title="Wrap in LaTeX (coming soon)"
            style={{
              padding: "0.35rem",
              borderRadius: "0.5rem",
              background: "none",
      ...
      >
            ...
            >
              {TF_OPTIONS.map((opt, i) => (
                <button
                  key={opt.label}
                  onClick={() =>
                    onChange?.({ correct: i, options: ["True", "False"] })
                  }
                  style={{
                    padding: "1rem",
                    ...
                    border: `2px solid ${questionData.correct === i ? opt.border : "rgba(255,255,255,0.08)"}`,
                    color: questionData.correct === i ? opt.color : "#94a3b8",
                    fontSize: "1rem",
                    fontWeight: 700,
                    fontFamily: "inherit",
                ...
                >
                  {questionData.correct === i && <Check size={16} />}
                  {opt.label}
                </button>
              ))}
            </motion.div>
              ...
              {OPTION_META.slice(0, visibleOptions).map((ans, i) => (
                <div
                  ...
                  style={{
                    ...
                    borderRadius: "0.7rem",
                    background:
                      !isPoll && questionData.correct === i
                        ? "rgba(16,185,129,0.1)"
                        : "rgba(255,255,255,0.04)",
                    border: `1px solid ${!isPoll && questionData.correct === i ? "rgba(16,185,129,0.35)" : "rgba(255,255,255,0.07)"}`,
                    boxShadow:
                      !isPoll && questionData.correct === i
                  ...
                  {!isPoll && (
                    <button
                      ...
                      style={{
                        ...
                        flexShrink: 0,
                        cursor: "pointer",
                        border: `2px solid ${questionData.correct === i ? "#10b981" : "rgba(255,255,255,0.2)"}`,
                        background:
                          questionData.correct === i
                            ? "#10b981"
                            : "transparent",
        ...
        >
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.4rem" }}>
            ...
            >
              {TIME_OPTIONS.map((t) => (
                <option key={t} style={{ background: "#0f172a" }}>
                  {t}
                </option>
              ))}
            </select>
                ...
                style={{
                  ...
                  background:
                    pointMode === p.key
                      ...
                      : "transparent",
                  color:
                    pointMode === p.key ? p.color : "rgba(148,163,184,0.45)",
                }}
              >
                <Zap
                  size={10}
