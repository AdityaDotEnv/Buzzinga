  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        transition={{
          background: {
            duration: isCountingDown ? 0.5 : 20,
            repeat: isCountingDown ? 0 : Infinity,
            ease: "linear",
          },
          filter: { duration: 1 },
        }}
      ...
      <div
        style={{
          ...
          zIndex: 0,
          pointerEvents: "none",
          opacity: isCountingDown ? 0.8 : 0.4,
        }}
      >
        ...
        {isCountingDown && (
          <motion.div
            ...
            style={{
              ...
              zIndex: 900,
              background:
                "radial-gradient(circle, transparent 20%, #0a0a1a 100%)",
              pointerEvents: "none",
            }}
          />
        )}
      ...
      <AnimatePresence>
        {showToast && (
          <SuccessToast
            message={`Welcome, ${nickname || "Player"}!`}
            ...
            >
              <motion.span
                ...
                style={{
                  ...
                  fontWeight: 900,
                  color: "#fff",
                  textShadow: `0 0 40px ${avatarColor}`,
                }}
              >
