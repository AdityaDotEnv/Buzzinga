    ...
    >
      {Array.from({ length: 28 }).map((_, i) => (
        <motion.div
          ...
          style={{
            ...
            width: 9,
            height: 18,
            background: `hsl(${14 + (i % 5) * 12},100%,58%)`,
      ...
      <div
        style={{
          position: "absolute",
          inset: 0,
          boxShadow: "inset 0 0 60px rgba(249,115,22,0.35)",
          pointerEvents: "none",
          borderRadius: 0,
        }}
      />
    ...
    >
      ...
      <div style={{ position: "relative", zIndex: 10 }}>
        ...
        >
          <div>
            ...
            <div
              style={{ fontWeight: 800, fontSize: "0.9rem", color: "#06b6d4" }}
            >
              {roomCode}
            </div>
          </div>
        ...
        {(phase === "question" || phase === "locked" || phase === "result") && (
          ...
          >
            ...
            <AnswerFeedback
              ...
              selected={selected}
              selectedColor={
                selected !== null ? SHAPE_CONFIG[selected].color : undefined
              }
              selectedGlow={
                selected !== null ? SHAPE_CONFIG[selected].glow : undefined
              }
              answerTime={0}
              totalTime={15}
          ...
          >
            ...
            <motion.p
              ...
              style={{
                ...
                fontWeight: 900,
                color: "#f43f5e",
                textShadow: "0 0 35px rgba(244,63,94,0.65)",
                margin: 0,
              }}
            >
              Time's Up!
      ...
      {streak > 0 && (phase === "question" || phase === "locked") && (
        ...
        >
          <Flame
            size={15}
            style={{ color: streak >= 3 ? "#fff" : "#fbbf24" }}
          />
